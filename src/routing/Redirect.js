...
export class Redirect extends React.PureComponent<RedirectProps> {
  ...
  render() {
    ...
    if (to instanceof InjectedPath) {
      return <ReactRouterRedirect {...sanitizeProps(to.getPath(), rest)} to={getFullRoute(to, rest)} />;
    }

    if (typeof to === "string") {
      return <ReactRouterRedirect {...sanitizeProps(to, rest)} to={getFullRoute(to, rest)} />;
    }
